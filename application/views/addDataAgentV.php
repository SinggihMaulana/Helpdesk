...
<body>
    ...
    <div class="content">
        ...
        <div class="isicontent">
            <div class="navigasi">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <img src="assets/img/iconagent.png" alt="" class="img-rounded img-responsive" style="width: 45px;" />
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="isi">
            ...
            <form action="<?= site_url('dataagentC/add') ?>" method="post">
                <br>
                <div class="row">
                    <div class="header">
                        <h4>Add New "Agent"</h4>
                ...
                <div class="row">
                    <div class="col-sm-2" id="bagianupload">
                        <img src="assets/img/iconagent.png" alt="Cinque Terre" width="150">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-inline row-sm-5 mb-3">
                            <label for="email" class="col-sm-5">ID Agent :</label>
                            <input type="text" class="form-control-sm-sm" id="id_agent" name="id_agent" placeholder="Insert Text Here...">
                        </div>
                        <div class="form-inline row-sm-5 mb-3">
                            ...
                            <select name="category" id="category">
                                ...
                                <option value="Independent Support">Independent Support</option>
                                <option value="Support Business Units">Support Business Units</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        ...
                        <div class="form-inline row-sm-5 mb-3">
                            <label for="name" class="col-sm-5">NIK :</label>
                            <input type="text" class="form-control-sm-sm" id="nik" name="nik" placeholder="Insert Text Here...">
                        </div>
                        <div class="form-inline row-sm-5 mb-3">
                            <label for="email" class="col-sm-5">Address :</label>
                            <textarea type="text" class="form-control-sm-sm" id="address" name="address" placeholder="Insert Text Here..."></textarea>
                        </div>

                        <div class="btnaksi">
                            <a class="btn btn-default" id="btncancel" href="<?= site_url('dataagentC') ?>">Cancel</a>
