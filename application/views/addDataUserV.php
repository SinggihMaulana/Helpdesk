...
<body>
    ...
    <div class="content">
        ...
        <div class="isi">
            ...
            <div class="row">
                <form action="<?= site_url('datauserC/add') ?>" method="post">
                    <br>
                    <div class="row">
                        <div class="header">
                            <h4>Add New "User"</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-inline row-sm-5 mb-3">
                                ...
                                <input type="text" class="form-control-sm-sm" id="nama" name="nama" placeholder="Insert Text Here...">
                            </div>
                            <!-- <div class="form-inline row-sm-5 mb-3">
                                <label for="email" class="col-sm-5">ID Number :</label>
                                <input type="text" class="form-control-sm-sm" id="email" name="" placeholder="Insert Text Here...">
                            </div> -->
                            <div class="form-inline row-sm-5 mb-3">
                                <label for="name" class="col-sm-5">Date of Birth :</label>
                                <input type="date" class="form-control-sm-sm" id="tanggal_lahir" name="tanggal_lahir" placeholder="Insert Text Here...">
                            </div>
                            <div class="form-inline row-sm-5 mb-3">
                                <label for="email" class="col-sm-5">Born Place :</label>
                                <input type="text" class="form-control-sm-sm" id="tempat_lahir" name="tempat_lahir" placeholder="Insert Text Here...">
                            </div>
                            <!-- <div class="form-inline row-sm-5 mb-3">
                                <label for="name" class="col-sm-5">Gender :</label>
                                <input type="text" class="form-control-sm-sm" id="name" name="" placeholder="Insert Text Here...">
                            </div> -->
                        </div>
                        <div class="col-sm-5">
                            <div class="form-inline row-sm-5 mb-3">
                                <label for="name" class="col-sm-5 col-form-label ">Phone Number :</label>
                                <input type="text" class="form-control-sm-sm" id="nomer_tlp" name="nomer_tlp" placeholder="Insert Text Here...">
                            </div>
                            <div class="form-inline row-sm-5 mb-3">
                            ...
                            <!-- <div class="form-inline row-sm-5 mb-3">
                                <label for="name" class="col-sm-5">Account Number :</label>
                                <input type="text" class="form-control-sm-sm" id="name" name="" placeholder="Insert Text Here...">
                            </div> -->
                            <div class="form-inline row-sm-5 mb-3">
                                <label for="email" class="col-sm-5">Home Address :</label>
                                <textarea type="text" class="form-control-sm-sm" id="alamat" name="alamat" placeholder="Insert Text Here..."> </textarea>
                            </div>
                            <!-- <div class="form-inline row-sm-5 mb-3">
