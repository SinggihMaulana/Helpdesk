...
<body>
    ...
    <div class="content">
        ...
        <div class="isi">
            ...
            <div class="row">
                <div class="button">
                    <a href="<?php base_url() ?>dataagentC/addDataAgent"><button class="btn"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New</button></a>
            ...
            <div class="row" id="cardbody">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="<?php site_url() ?>assets/img/iconagent.png" alt="Admin" width="150">
                                <div class="mt-3">
                                    <h5><?= $a['nama_agent'] ?></h5>
                                    <h5><?= $a['kategori_agent'] ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="assets/img/iconagent.png" alt="Admin" width="150">
                            <div class="mt-3">
                                <h5>Agent 2</h5>
