...
<body>
    ...
    <div class="content">
        ...
        <div class="isi">
            ...
            <div class="row">
                <form action="<?= site_url('datapegawaiC/add') ?>" method="post">
                    <br>
                    <div class="row">
                        <div class="header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-inline row-sm-5 mb-3">
                                ...
                                <input type="text" class="form-control-sm-sm" id="id_number" name="id_number" placeholder="Insert Text Here...">
                            </div>
                            <div class="form-inline row-sm-5 mb-3">
                                <label for="name" class="col-sm-5">Date of Birth :</label>
                                <input type="date" class="form-control-sm-sm" id="birth" name="birth" placeholder="Insert Text Here...">
                            </div>
                            <div class="form-inline row-sm-5 mb-3">
                                <label for="email" class="col-sm-5">ID Card Number :</label>
                                <input type="text" class="form-control-sm-sm" id="id_card_number" name="id_card_number" placeholder="Insert Text Here...">
                            </div>
                            <div class="form-inline row-sm-5 mb-3">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-inline row-sm-5 mb-3">
                                <label for="name" class="col-sm-5">Born Place :</label>
                                <input type="text" class="form-control-sm-sm" id="born_place" name="born_place" placeholder="Insert Text Here...">
                            </div>
                            <div class="form-inline row-sm-5 mb-3">
                            ...
                            <div class="form-inline row-sm-5 mb-3">
                                ...
                                <input type="text" class="form-control-sm-sm" id="religion" name="religion" placeholder="Insert Text Here...">
                            </div>
                            <div class="btnaksi">
                                <a class="btn btn-default" id="btncancel" href="<?= site_url('datapegawaiC') ?>">Cancel</a>
