...
<body>
    ...
    <div class="content">
        ...
        <div class="isi">
            ...
            <div class="row">
                <div class="button">
                    <a href="<?php base_url() ?>datarequestC/addDataRequest"><button class="btn"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New</button></a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="assets/img/iconrequest.png" alt="Admin" width="150">
                                <div class="mt-3">
                                    <h5><?= $r['case_req'] ?></h5>
                                    <h5><?= $r['case_kategori'] ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
