...
<body>
    ...
    <div class="content">
        ...
        <div class="isi">
            ...
            <form action="<?= site_url('datafaqC/add') ?>" method="post">
                <br>
                <div class="row">
                    <div class="header">
                        <h4>Add New "FAQ"</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <div class="form-inline row-sm-5 mb-3">
                            ...
                            <input type="text" class="form-control-sm-sm" id="id_faq" name="id_faq" placeholder="Insert Text Here...">
                        </div>
                        <div class="form-inline row-sm-5 mb-3">
                            <label for="name" class="col-sm-5">Question :</label>
                            <textarea class="form-control-sm-sm" id="question" name="question" placeholder="Insert Text Here..."></textarea>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <div class="form-inline row-sm-5 mb-3">
                            <label for="name" class="col-sm-5 col-form-label ">Answer :</label>
                            <textarea class="form-control-sm-sm" id="answer" name="answer" placeholder="Insert Text Here..."></textarea>
                        </div>
                        <div class="btnaksi">
                            <a class="btn btn-default" id="btncancel" href="<?= site_url('datafaqC') ?>">Cancel</a>
